...
describe('Row', function () {
  it('存在.', function () {
    expect(_col2.default).to.be.ok;
  });
  it('接受span属性', function () {
    var div = document.createElement('div');
    document.body.appendChild(div);
    var Constructor = _vue2.default.extend(_col2.default);
...
},{"vue":"hTSW","../src/col":"xFMe"}]},{},["FIP2"], null)
