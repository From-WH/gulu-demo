...
describe('Row', function () {
  it('存在.', function () {
    expect(_row2.default).to.be.ok;
  });
  it('接受gutter属性.', function (done) {
  ...
  it('接受align属性', function () {
    var div = document.createElement('div');
    document.body.appendChild(div);
    var Constructor = _vue2.default.extend(_row2.default);
...
},{"vue":"hTSW","../src/row":"HTlb","../src/col":"xFMe"}]},{},["Tgvo"], null)
